...
class ApiPrivate{{cookiecutter.model}}ViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="Create {{cookiecutter.module_name}}", request_body=CreateSerializer")
    ...
    @swagger_auto_schema(operation_description="Update {{cookiecutter.module_name}}", request_body=UpdateSerializer)
    ...
    @swagger_auto_schema(operation_description="Delete {{cookiecutter.module_name}}")
