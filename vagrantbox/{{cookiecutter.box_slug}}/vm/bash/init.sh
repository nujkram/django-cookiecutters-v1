...
echo -e "${INFO}Installing Virtual Environment...${SUBDUED}"
sudo apt install -y python-virtualenv

echo -e "${INFO}Creating Virtual Environment...${SUBDUED}"
mkdir /home/vagrant/venv
virtualenv --python=python3.8 --always-copy /home/vagrant/venv
